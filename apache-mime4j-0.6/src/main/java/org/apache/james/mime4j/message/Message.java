...
public class Message extends Entity implements Body {
    ...
    public Message(InputStream is) throws IOException, MimeIOException {
        this(is, null, DefaultStorageProvider.getInstance(), "US-ASCII");
    }
     ...
     *            default charset for parsing when no charset is specified in message.
     * @throws IOException
     *             on I/O errors.
     * @throws MimeIOException
     *             on MIME protocol violations.
    ...
    public Message(InputStream is, MimeEntityConfig config,
            ...
            MimeIOException {
        this(is, config, DefaultStorageProvider.getInstance(), defaultCharset);
    }
     ...
     */
    public Message(InputStream is, MimeEntityConfig config,
            StorageProvider storageProvider, String defaultCharset)
			throws IOException, MimeIOException {
        try {
            MimeStreamParser parser = new MimeStreamParser(config);
            MessageBuilder builder = new MessageBuilder(this, storageProvider,
        		defaultCharset);
