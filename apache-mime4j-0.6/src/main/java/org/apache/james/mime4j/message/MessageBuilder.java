...
public class MessageBuilder implements ContentHandler {
    ...
    private String defaultCharset = "ISO8859-1";
    ...
    public void field(Field field) throws MimeException {
        ...
        if (CharsetUtil.isASCII(raw.toByteArray()))
            parsedField = AbstractField.parse(raw);
        else
            parsedField = AbstractField.parse(raw, Charset.forName(defaultCharset));
