...
/* Modified by Juanjo Alvarez Martinez on behalf of Almar Soft SL */
...
public class Article implements Threadable {
    ...
    private String[] referencesArray = null;
    ...
    public String[] getReferences() {
    	...
    	if (referencesArray == null) {
	        ...
	        if (references == null) {
	        	referencesArray = new String[0];
	        } else {
	        
		        ArrayList<String> list = new ArrayList<String>();
		        int terminator = references.toString().indexOf(':')+2;
		        StringTokenizer st = new StringTokenizer(references.substring(terminator), "\t");
		        while (st.hasMoreTokens()) {
		            list.add(st.nextToken());
		        }
		        
		        referencesArray = list.toArray(new String[list.size()]);
	        }
    	}
	...
	public void setSimplifiedSubject(String clean_subject) {
		simplifiedSubject = clean_subject;
	}
    ...
    // Juanjux: Static version, useful on MessageView to simplify the subject from the header data
